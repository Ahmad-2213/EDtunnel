...
const พร็อกซีไอพีs = ['62.3.12.185'];
...
let dohURL = 'https://dns.digitalsize.net/dns-query'; // https://cloudflare-dns.com/dns-query or https://dns.google/dns-query
...
async function วเลสOverWSHandler(request) {
	...
	webSocket.accept({
maxPayload: 1048576, // Increase the maximum payload size 1048576
